...
选择一个增量序列，初始增量`gap=length/2`，后续元素依次为前一元素除2，直至`gap=1`；每轮以`gap`为步长，在列表上进行采样，将列表分为`gap`个小组，在每个小组内进行选择排序；重复第二步，直至`gap=1`；
...
![121](https://images2015.cnblogs.com/blog/1024555/201612/1024555-20161218163120151-452283750.png)
...
![jishu](https://images0.cnblogs.com/i/497634/201403/161837176365265.jpg)
